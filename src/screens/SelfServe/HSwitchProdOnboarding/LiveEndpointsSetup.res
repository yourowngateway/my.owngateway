  ...
  let make = (
    ...
    <div>
      ...
      <ProdOnboardingUIUtils.SetupWebhookProcessor
        ...
        subtextSectionText="Use this key to authenticate all calls from your application's client to OwnGateway SDK"
        customRightSection={<HelperComponents.KeyAndCopyArea
      ...
      <UIUtils.RenderIf
        ...
        <UIUtils.RenderIf condition={paymentResponseHashKey->LogicUtils.isNonEmptyString}>
          <ProdOnboardingUIUtils.SetupWebhookProcessor
            ...
            subtextSectionText="Download the provided key to authenticate and verify live events sent by OwnGateway. Learn more"
            customRightSection={<HelperComponents.KeyAndCopyArea
      ...
      <ProdOnboardingUIUtils.SetupWebhookProcessor
        ...
        subtextSectionText="Use this key to authenticate all API requests from your application's server to OwnGateway server"
    ...
    <ProdOnboardingUIUtils.WarningBlock
      customComponent={Some(<>
        <p className={`${subTextStyle} !opacity-100`}>
          {"Not integrated with OwnGateway yet? Visit our"->React.string}
        </p>
        <p
